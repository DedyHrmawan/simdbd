                                ...
                                foreach($carousel as $item){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dark fw-bolder">
                                            <span class="badge badge-'.$badge.'">'.$textbadge.'</span>
                                            <!-- <span class="badge badge-danger">Diarsipkan</span> -->
                                        </td>
                                        <td class="">
                                            <a href="" title="Detail Gambar Carousel" data-bs-toggle="modal" data-bs-target="#mdl_detCarousel" data-id="'.$item->id_carousel.'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mdl_detCarousel me-1">
                                            ...
                                            <a href="" title="Edit Gambar Carousel" data-bs-toggle="modal" data-bs-target="#mdl_editCarousel" data-id="'.$item->id_carousel.'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mdl_editCarousel m-1">
                                            ...
                                            <a href="#" title="Hapus Gambar Carousel" data-bs-toggle="modal" data-bs-target="#mdl_delCarousel" data-id="'.$item->id_carousel.'" class="btn btn-icon btn-bg-light btn-active-color-primary mdl_delCarousel btn-sm m-1">
                                                <span class="svg-icon svg-icon-3">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= site_url('carousel/tambah') ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" tabindex="-1" id="mdl_editCarousel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input type="hidden" id="editId" name="id_carousel">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
...
<div class="modal fade" tabindex="-1" id="mdl_delCarousel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= site_url('carousel/hapus') ?>" method="post">
                <div class="modal-body">
                    <p>Apakah anda yakin ingin menghapus Gambar Carousel tersebut ?</p>
                </div>

                <div class="modal-footer">
                    <input type="hidden" id="hapusId" name="id_carousel">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
...
<script>
    $('#tabelCarousel tbody').on('click', '.mdl_detCarousel', function() {
    ...
    $('#tabelCarousel tbody').on('click', '.mdl_editCarousel', function() {
        const id = $(this).data('id');
        $.ajax({
            url: "<?= site_url('carousel/ajxGet') ?>",
            type: "post",
            ...
            success: res => {
                ...
                $('#editId').val(res[0].id_carousel)
            }
        })
    })

    $('#tabelCarousel tbody').on('click', '.mdl_delCarousel', function() {
        const id = $(this).data("id")
        $('#hapusId').val(id)
    })
</script>