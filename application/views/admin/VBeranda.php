                        ...
                        <div class="col-xl-3">
                            <span href="#" class="card bg-light hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-400">Widget 1</div>
                                </div>
                            </span>
                        </div>
                        <div class="col-xl-3">
                            <span href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-gray-100">Widget 2</div>
                                </div>
                            </span>
                        </div>
                        <div class="col-xl-3">
                            <span href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="fw-bold text-white">Widget 3</div>
                                </div>
                            </span>
                        </div>
                        <div class="col-xl-3">
                            <span href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                                <div class="card-body">
                                    ...
                                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">50</div>
                                    <div class="fw-bold text-white">Widget 4</div>
                                </div>
                            </span>
                        </div>
                    </div>
