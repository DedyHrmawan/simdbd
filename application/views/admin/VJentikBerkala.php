            ...
            <div class="modal-body">
                <form action="<?= site_url('') ?>" method="post">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input class="form-control form-control-solid" placeholder="Pilih Tanggal Pemeriksaan" id="add_tglPJB" required />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
            ...
            <div class="modal-body">
                <form action="<?= site_url('') ?>" method="post">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input class="form-control form-control-solid" value="08 Oktober 2022" id="edit_tglPJB" required />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Pemeriksaan Tandon Air Dalam Rumah</span>
